  ...
  (0, (_createClass2 || _load_createClass()).default)(IOSBuilder, [{
    ...
    value: function () {
      var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee() {
        var _ref2, _ref2$args, username, experienceName, bundleIdentifier, sdkVersion, credentialMetadata, clearOnly, publishedExpIds;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 29:
                ...
                if ((_auth || _load_auth()).DEBUG) {
                  if (_context.t0.stdout !== undefined) {
                    ...
                    (_log || _load_log()).default.error(_context.t0);
                  }
                }
                throw _context.t0;
              ...
              case 36:
                ...
                _context.next = 39;
                return this.build(publishedExpIds, 'ios', { bundleIdentifier: bundleIdentifier });
    ...
    value: function () {
      ...
      function runningAsExpert(_x3, _x4) {
    ...
    value: function () {
      ...
      function userProvidedOverride(_x6, _x7, _x8) {
    ...
    value: function () {
      ...
      function _ensureAppExists(_x9, _x10, _x11, _x12) {
    ...
    value: function () {
      ...
      function produceProvisionProfile(_x13, _x14, _x15, _x16, _x17) {
    ...
    value: function () {
      ...
      function expoManagedResource(_x18, _x19, _x20, _x21, _x22, _x23) {
    ...
    value: function () {
      ...
      function _revokeHelper(_x24, _x25, _x26, _x27, _x28) {
    ...
    value: function () {
      ...
      function _handleRevokes(_x29, _x30, _x31, _x32, _x33) {
    ...
    value: function () {
      ...
      function _validateCredsEnsureAppExists(_x34, _x35, _x36, _x37) {
    ...
    value: function () {
      ...
      function runningAsExpoManaged(_x38, _x39, _x40, _x41) {
    ...
    value: function () {
      ...
      function _chooseDistCert(_x43, _x44) {
