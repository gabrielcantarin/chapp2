...
var printUsage = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(projectDir) {
    var _ref2, dev, openDevToolsAtStartup, user, devMode, iosInfo;
...
var printServerInfo = exports.printServerInfo = function () {
  var _ref3 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee2(projectDir) {
    var url, user, wrap, wrapItem, item, iosInfo;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            if (user) {
              (_log || _load_log()).default.nested(item('Sign in as ' + i('@' + user.username) + ' in Expo Client on Android or iOS. Your projects will automatically appear in the "Projects" tab.'));
            }
  ...
  var _ref4 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee6(projectDir) {
    var handleKeypress = function () {
      var _ref5 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee5(key) {
        ...
        var _ref6, success, error, _ref7, _success, msg, _ref8, devToolsPort, enabled, lanAddress, defaultRecipient, rl, _handleKeypress, _cleanup, _cancel, projectSettings, dev, reset, user;
        ...
        return (_regenerator || _load_regenerator()).default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.t0 = key;
                _context5.next = _context5.t0 === CTRL_C ? 3 : _context5.t0 === CTRL_D ? 3 : _context5.t0 === CTRL_L ? 5 : _context5.t0 === '?' ? 7 : _context5.t0 === 'a' ? 10 : _context5.t0 === 'i' ? 19 : _context5.t0 === 'c' ? 28 : _context5.t0 === 'd' ? 32 : _context5.t0 === 'D' ? 40 : _context5.t0 === 'e' ? 49 : _context5.t0 === 'p' ? 65 : _context5.t0 === 'r' ? 75 : _context5.t0 === 'R' ? 75 : _context5.t0 === 's' ? 80 : 105;
                break;
              ...
              case 34:
                ...
                (0, (_opn || _load_opn()).default)('http://localhost:' + devToolsPort);
                printHelp();
                return _context5.abrupt('return');
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          ...
                          case 6:
                            ...
                            _context4.prev = 8;
                            _context4.next = 11;
                            return (_xdl || _load_xdl()).Exp.sendAsync(sendTo, lanAddress, true);
              ...
              case 94:
                (_xdl || _load_xdl()).Config.offline = false;
                _context5.next = 100;
                break;

              case 97:
                _context5.prev = 97;
                _context5.t1 = _context5['catch'](91);
