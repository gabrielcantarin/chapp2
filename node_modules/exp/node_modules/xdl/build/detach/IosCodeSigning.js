...
let createEntitlementsFile = (() => {
  var _ref5 = _asyncToGenerator(function* ({ generatedEntitlementsPath, plistData, archivePath }) {
...
function _ensureBundleIdentifierIsValid(plistData, { bundleIdentifier, teamID }) {
  ...
  if (expectedApplicationIdentifier !== actualApplicationIdentifier) {
    ...
    throw new Error(`validateProvisioningProfile: wrong bundleIdentifier found in provisioning profile; expected: ${bundleIdentifier}, found: ${actualBundleIdentifier}`);
  }
}
