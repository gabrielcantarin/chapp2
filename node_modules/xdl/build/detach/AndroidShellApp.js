...
let runShellAppModificationsAsync = exports.runShellAppModificationsAsync = (() => {
  var _ref9 = _asyncToGenerator(function* (context, isDetached = false) {
    ...
    if (manifest.android && manifest.android.googleServicesFile) {
      ...
      yield (_fsExtra || _load_fsExtra()).default.writeFile(_path.default.join(shellPath, 'app', 'google-services.json'), manifest.android.googleServicesFile);

      yield regexFileAsync('<!-- ADD FCM CONFIG HERE -->', `<service
      ...
      </service>`, _path.default.join(shellPath, 'app', 'src', 'main', 'AndroidManifest.xml'));

      yield regexFileAsync('FCM_ENABLED = false', 'FCM_ENABLED = true', _path.default.join(shellPath, 'app', 'src', 'main', 'java', 'host', 'exp', 'exponent', 'generated', 'AppConstants.java'));
    }
