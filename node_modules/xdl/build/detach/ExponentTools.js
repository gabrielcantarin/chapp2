...
let getResolvedLocalesAsync = (() => {
  var _ref5 = _asyncToGenerator(function* (inMemoryManifest) {
    const locales = {};
  ...
  return function getResolvedLocalesAsync(_x5) {
    return _ref5.apply(this, arguments);
  };
})();

let regexFileAsync = (() => {
  var _ref6 = _asyncToGenerator(function* (regex, replace, filename) {
  ...
  return function regexFileAsync(_x6, _x7, _x8) {
...
let deleteLinesInFileAsync = (() => {
  var _ref7 = _asyncToGenerator(function* (startRegex, endRegex, filename) {
    let file = yield (_fsExtra || _load_fsExtra()).default.readFile(filename);
    let fileString = file.toString();
  ...
  return function deleteLinesInFileAsync(_x9, _x10, _x11) {
